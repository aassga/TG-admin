			...
			yesBtn : {
				...
				click : function(e) {
					...
					if(tabs.selectedIndex === 1){
						var file = document.getElementsByClassName("ke-upload-file"); // 获取kindeditor的<input typ="file">
						var formData = new FormData();
						formData.append('img', file[0].files[0]);
						formData.append('siteId',JSON.parse(localStorage.nowSite).id);
						dialog.showLoading(self.lang('uploadLoading'));
						var xhr = new XMLHttpRequest();
						var url = "/api/v2/uploadImg";   // 文件上传的地址
						...
						xhr.onreadystatechange = function () {
							if (xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 304)) {
								...
								img.src =host+srcUrl;
								img.onload = function () {
									clickFn.call(self, img.src, '图片的名字', img.width + 'px', img.height + 'px', 0, 'center');
								}
								setTimeout(function () {
									self.hideDialog().focus();
								}, 0);
...
SWFUpload.prototype.callFlash = function (functionName, argumentArray) {
	console.log(functionName,argumentArray)
