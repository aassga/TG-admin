    ...
    submit() {
      this.$refs.formKey.validate((valid) => {
        if (valid) {
          ...
          // if (arr.includes('按输赢')) {
          //     if (this.formKey.shuying_max <= this.formKey.shuying_min) {
          //         this.$Message.warning('输赢范围上限金额必须大于下限金额！');
          //         return;
          //     }
          // }
          // if (arr.includes('按打码')) {
          //     if (this.formKey.bet_max <= this.formKey.bet_min) {
          //         this.$Message.warning('打码范围上限金额必须大于下限金额！');
          //         return;
          //     }
          // }
          // if (arr.includes('按存款')) {
          //     if (this.formKey.pay_max <= this.formKey.pay_min) {
          //         this.$Message.warning('存款范围上限金额必须大于下限金额！');
          //         return;
          //     }
          // }
