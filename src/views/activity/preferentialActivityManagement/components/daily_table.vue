                                ...
                                [
                                    ...
                                    h(
                                        'Select',
                                        {
                                            ...
                                            props: {
                                                value: this.table.data[params.index].game_class_id, // 获取选择的下拉框的值
                                                transfer: true,
                                                labelInValue: true,
                                                clearable: true
                                            },
                                            on: {
                                                'on-change': e => {
                                                    if (e) {
                                                        this.table.data[params.index].game_class_id = e.value;
                                                    } else {
                                                        this.table.data[params.index].game_class_id = '';
                                                    }
                                                    this.queryList = [];
                                                    this.table.data[params.index].game_id = '';
                                                    this.table.data[params.index].game_name = '';
                                                    this.sendMsg();
                                                }
                                            }
                                        },
                                        this.gameList.map(item => {
                                            return h('Option', {
                                                props: {
                                                    value: item.game_class_id,
                                                    label: item.game_class_name
                                                }
                                            });
                                        })
                                    ),
...

                                        {
                                            ...
                                            on: {
                                                'on-query-change': e => {
                                                    ...
                                                    vm.timer = setTimeout(() => {
                                                        if (e && this.table.data[params.index].game_class_id) {
                                                            let data = { siteId: this.$root.nowSite.id, name: e, game_class_id: this.table.data[params.index].game_class_id };
                                                            this.gameQuery(data);
                                                        }
                                                    }, 1000);
                                                },
