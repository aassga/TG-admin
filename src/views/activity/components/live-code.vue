...
export default {
    props: ['showBtn', 'newSearchKey'], //true-不编辑
    components: {
        Tables,
        Icons
    },
            ...
            table: {
                ...
                columns: [
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Input', {
                                    ...
                                    on: {
                                        'on-change': e => {
                                            this.table.data[params.index].level_money = e.target.value;
                                            this.$emit('sendNewData', this.table.data);
                                        }
                                    }
                                })
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Input', {
                                    ...
                                    on: {
                                        'on-change': e => {
                                            this.table.data[params.index].every_month_reward = e.target.value;
                                            this.$emit('sendNewData', this.table.data);
                                        }
                                    }
                                })
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Input', {
                                    ...
                                    on: {
                                        'on-change': e => {
                                            this.table.data[params.index].jiebei_amount = e.target.value;
                                            this.$emit('sendNewData', this.table.data);
                                        }
                                    }
                                })
                            ...
                            return h('div', [
                                ...
                                h(
                                    'Select',
                                    {
                                        ...
                                        on: {
                                            'on-change': val => {
                                                this.table.data[params.index].level_status = !this.table.data[params.index].level_status;
                                                this.$emit('sendNewData', this.table.data);
                                            }
                                        }
                                    },
                    ...
                    },
                    {
                        ...
                        minWidth: 110,
                        render: (h, params) => {
                            return <span>{this.$root.newUnixTime(params.row.update_time)}</span>;
                        }
                    }
                ]
            }
    ...
    methods: {
        ...
        onPageSizeChange(pageSize) {
            ...
            let data = { ...this.newSearchKey, siteId: this.$root.nowSite.id, active_type: 'shixun', limit: pageSize };
