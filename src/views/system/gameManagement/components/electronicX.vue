          ...
          <Row v-if="activeKey == 1">
            ...
            >
              ...
              >
                ...
                <span class="line gamePlatform" v-if="bList[bKey1].name=='全部'">
                  <span class="ib sanjiaoxing"></span>
                  {{item.className}}
                </span>
                <Icons
            ...
            <div class="mb20" v-if="typeId=='10001'&&showTwo">
              ...
              >
                ...
                >
                  ...
                  <span class="line gamePlatform" v-if="bKey1=='0'">
                    <span class="ib sanjiaoxing"></span>
                    {{item.className}}
                  </span>
                  <Icons
              ...
              <div v-if="showTre">
                <span
                  class="txt-a mb20 ib w100 nodata"
  ...
  methods: {
    setList(key1, key2, key3) {
      ...
      this.showTre = this.showTwo
        ...
        : 0; //三级分类是否显示
      if (this.type == 10005) {
        // if(this.bList[this.bKey1].name=='全部'){  //捕鱼初始数据
        //   this.bList[this.bKey1].games=[];
        //   this.data.allGames[10005].list.forEach(t=>{
        //     t.list.forEach(m=>{
        //       this.bList[this.bKey1].games.push(m)
        //     })
        //   })
        // }else {
        //   this.data.allGames[10005].list.forEach(t=>{
        //     if(t.name == this.bList[this.bKey1].name){
        //       this.bList[this.bKey1].games=t.list
        //     }
        //   })
        // }
        this.setAllGame();
