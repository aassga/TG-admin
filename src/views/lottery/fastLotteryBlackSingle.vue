  ...
  <div>
    <div class="v2-search">
      <Form ref="searchKey" inline>
        ...
        <FormItem label="站点名称">      
           <Select  clearable class="w120x" v-model="searchKey.siteId" placeholder="全部" >
      ...
      <div slot="content" class="v2-form-wrapper">
        <Form ref="addBlack" :label-width="160" :rules="rules" :model="addBlack" style="width:570px;" >
          <FormItem label='站点名称' prop='siteId' v-if="title == '添加黑名单'">
            <Select v-model="addBlack.siteId"  class="w260x" placeholder='关键字查询' filterable clearable>
