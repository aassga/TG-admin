const system = {
  ...
  children: [{
      ...
      children: [
        {
          path: 'domainLevelList',
          name: 'domainLevelList',
          routeKey: 'domainLevelList',
          parentKey: 'domain',
          meta: {
            title: '域名层级',
          // hideInMenu: true,
          ...
          component: () =>
            import('@/views/system/domainManagement/domainLevelList')
        },
        {
          path: 'domainGroup',
          name: 'domainGroup',
        ...
        },
        {
          ...
          name: 'advBlanklist',
          parentKey: 'domain',
          routeKey: 'advBlanklist',
          meta: {
            title: '广告黑名单',
            icon: 'yaoqingma_huaban',
            routeKey: 'advBlanklist'
          },
          component: () => import('@/views/system/domainManagement/advBlanklist')
        }
      ]
    },
    {
